  ...
  _createClass(Overlay, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['container', 'containerPadding', 'target', 'placement', 'shouldUpdatePosition', 'rootClose', 'children', 'transition', 'portalClassName']);
      ...
      child = _react2.default.createElement(
        _Position2.default,
        _extends({ ref: 'position' }, { container: container, containerPadding: containerPadding, target: target, placement: placement, shouldUpdatePosition: shouldUpdatePosition }),
        child
      );
